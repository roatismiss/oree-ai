/** Copy for the Approach page. Same voice rules as content/en.ts. */
...
export const story = {
  ...
  quote: "\"AI drafts. The human decides.\"",
  attribution: "Aminata Diabaté, Founder",
  titleTop: "More than a",
  titleBottom: "Tool review",
  paragraphs: [
  ...
  nameLabel: "The name",
  nameMetaphor:
    "The practice's name carries that experience: an orée is the edge of the woods — the place where you stand before stepping in, where the view is still clear.",
};
...
export const method = {
  ...
  steps: [
    ...
    },
    {
      ...
      en: "Engage",
      body:
        "We cost the plan and you approve it line by line. Each step names its human checkpoint, so you always know who signs and at what moment.",
    },
  ],
};
