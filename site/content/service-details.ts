...
export const serviceDetails: ServiceDetail[] = [
    ...
    deliverables: [
      {
        ...
        body: "Each recommendation with its effort, its sequence, and the obligation it satisfies. Approved by you, line by line.",
      },
      {
        title: "The task map",
...

  {
    ...
    n: "02",
    name: "Orée Support",
    eyebrow: "Service 02 · The rollout",
